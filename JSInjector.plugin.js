...
module.exports = (() => {
    const config = {
        ...
        "changelog":[
            {
                "title":"First plugin version",
                "items":[
                    "JS Editor",
                    "Executed scripts list",
                    "Load code from last executed",
                    "Script name protection"
                ]
            },
            {
                "title":"On-going",
    ...
    return class FakeDeafen extends Plugin {
        ...
        menu = {
            ...
            open() {
                ...
                if (!$('#JSI_window')[0]) {
                    ...
                    $('#JSI_window .header .close').on('click', _ => {this.menu.close()});
        ...
        __main__() {
            ...
            button.on('click', _ => {if (!this.menu.active) this.menu.open(); else this.menu.close()})
        };
